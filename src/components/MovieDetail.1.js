...
export function MovieDetail() {
  return (
    <section className="bg-indigo-900 h-screen">
      ...
      <div className="absolute top-1/4 p-8 inline-block">
        <div className="flex items-center">
          ...
          <div className="pl-4">
            ...
            <p className="text-xs text-gray-300 my-3 line-clamp-3">
              ...
              auditions and Sebastian, a jazz musician, scrapes by playing
              cocktail party gigs in dingy bars, but as success mounts they are
              faced with decisions that begin to fray the fragile fabric of
              their love affair, and the dreams they worked so hard to maintain
          ...
          <ul>
            <li className="my-2">
              <h2 className="text-xs">
                Director by:{" "}
                <span className="font-courier uppercase">Damien Chazelle</span>
              </h2>
            </li>
            <li className="my-2">
              <h2 className="text-xs">
